...
export default function RelatorioTopValor(props: Props) {
    const { tema, clientes, onClienteSelect } = props;
    ...
    const top5Produtos = useMemo(() => {
        return [...consumoProdutos].sort((a, b) => b.valor - a.valor).slice(0, 5);
    }, [consumoProdutos]);

    const top5Servicos = useMemo(() => {
        return [...consumoServicos].sort((a, b) => b.valor - a.valor).slice(0, 5);
    }, [consumoServicos]);
    ...
    const top5Total = useMemo(() => {
        ...
        return consumoTotal.sort((a, b) => b.valorTotal - a.valorTotal).slice(0, 5);
    }, [clientes, consumoProdutos, consumoServicos]);
